		...
		<div class="section">
			<div class="container">
				<div class="row align-items-center col-spacing-50">
                    ...
                    <a class="button button-lg button-rounded button-reveal-right-dark margin-top-30" href="{{ route('posts.index') }}"><span>Get In Touch</span><i class="ti-arrow-right"></i></a>
					</div>
